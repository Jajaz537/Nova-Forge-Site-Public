...
Assert-True ($shell.Contains("'slow-2g', '2g'")) 'prefetch-respects-slow-network'
Assert-True ($shell.Contains('url.origin !== location.origin')) 'prefetch-same-origin-only'
Assert-True ($shell.Contains('prefetched.size >= 6')) 'prefetch-bounded-count'
