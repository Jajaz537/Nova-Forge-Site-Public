...
| UI compte / profil premium | **TERMINÉ — preuve ciblée de code** | `qa/MODARYX-PROFILES-ACCOUNT-UI-20260920.md` + marker `PASS_TARGETED_PROFILES_ACCOUNT_UI` ; browser proof séparé vérifie le fallback statique fail-closed. |
