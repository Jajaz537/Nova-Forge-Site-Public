...
| UI communauté distante modérée | **TERMINÉ — preuve ciblée de code** | `qa/MODARYX-COMMUNITY-REMOTE-UI-20260920.md` + marker `PASS_TARGETED_COMMUNITY_REMOTE_UI` ; le mode local reste indépendant et le browser proof vérifie le fallback fail-closed. |
