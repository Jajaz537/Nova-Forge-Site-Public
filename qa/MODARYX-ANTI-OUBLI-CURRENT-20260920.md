...
3. Fermer les écarts produit encore réels sans les simuler : passkey finale, moteur de modération/publication, corpus réels, distribution, Storage Resolver, Repair Network, Guide et pont OS selon leurs dépendances.
