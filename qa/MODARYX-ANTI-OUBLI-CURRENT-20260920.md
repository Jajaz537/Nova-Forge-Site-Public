...
| Compte Fondateur / Administrateur MODARYX | **TERMINÉ — autorité DEV + preuves runtime modération/recours acquises** | PR #142 a intégré l'autorité serveur/UI. Auth0 DEV : `modaryx:founder`, `authority.role=founder`, capacités founder/administration/modération/recours confirmées. Preuve modération : HTTP 200, `held-for-review`, `received`, receipt + cleanup vrais. Preuve recours : HTTP 200, `upheld`, `rejected`, `received`, receipt + cleanup vrais. Aucun secret/token exposé ; cookie HttpOnly non extrait. Sources : `qa/MODARYX-FOUNDER-ADMIN-ACCESS-20260921.md`, `qa/MODARYX-FOUNDER-AUTH0-DEV-EVIDENCE-20260921.md`, `qa/MODARYX-FOUNDER-DEV-PROOF-SURFACE-20260921.md`. |
| Micro-surface Fondateur DEV temporaire | **TERMINÉ — retirée après preuves runtime** | Les deux mutations Fondateur sont acquises avec receipt + cleanup. `functions/founder-proof-dev.js` est supprimé du candidat de fermeture et son checker devient un garde anti-résurrection. Source historique : `qa/MODARYX-FOUNDER-DEV-PROOF-SURFACE-20260921.md`. |
