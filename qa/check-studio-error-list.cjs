...
const context={schemaStatus,document:{createElement:node}};vm.createContext(context);vm.runInContext(code,context);
...
console.log(JSON.stringify({status:'PASS',assertions:5,scope:'Actual error-list renderer in Node DOM model; not a native accessibility proof'}));
