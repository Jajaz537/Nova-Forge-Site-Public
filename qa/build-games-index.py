...
main = '''  <main id="main" class="project-page">
    ...
    <section class="section" aria-labelledby="games-title"><p class="eyebrow">Les univers du catalogue</p><h1 id="games-title">Un jeu. Vos prochaines explorations.</h1><p class="section-intro">Retrouvez les jeux représentés dans nos fiches de démonstration. Ces projets illustrent les outils MODARYX : ils ne constituent ni des fichiers distribués, ni une compatibilité testée.</p></section>
