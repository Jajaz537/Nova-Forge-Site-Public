...
- Assistant/guide surface: **Modaryx Guide**
- Domain: **modaryxmods.com**

## Homepage placement contract
1. Premium header/navigation at the top.
2. Editorial hero copy on the left.
3. Kingdom + Wolf/Dragon focus in the central visual area.
4. Vertical manifesto/brand rail on the right.
5. Five ecosystem/portal cards directly below the hero.
6. Four-stage companion progression: Bébés → Jeunes → Forgés → Royaux.
7. Vision card and lower ecosystem band.
8. Additional product content may continue below, but must not disturb the locked top composition.
...
- internal links and canonical audit;
- sitemap / robots audit;
- visible naming audit;
- static-first / no-fake-status checks;
- performance pass;
- only then consider making PR #11 ready and merging to `main`.
